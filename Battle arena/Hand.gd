...
#onready var Sniper = $Pivot/Camera/Hand/Sniper
#
...
#	if current_weapon==2:
#		if Input.is_action_pressed("Right_Click"):
#			transform.origin = transform.origin.linear_interpolate(lmg_ads_position, ADS_LERP * delta)
#		else:
#			transform.origin = transform.origin.linear_interpolate(lmg_default_position, ADS_LERP * delta)
#	if current_weapon==3:
#		if Input.is_action_pressed("Right_Click"):
#			transform.origin = transform.origin.linear_interpolate(shotgun_ads_position, ADS_LERP * delta)
#		else:
#			transform.origin = transform.origin.linear_interpolate(shotgun_default_position, ADS_LERP * delta)
#	if current_weapon==4:
#		if Input.is_action_pressed("Right_Click"):
